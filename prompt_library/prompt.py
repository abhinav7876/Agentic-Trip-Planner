...
SYSTEM_PROMPT = SystemMessage(
    ...
    - Weather details
    Guidelines:
    - If the user specifies a trip duration (like 3 days, 1 week, etc.), strictly follow it.
    - If no duration is mentioned, infer duration based on context:
    - Budget trip → 2–3 days
    - Long vacation or honeymoon → 7–10 days
    - General query → 3-day itinerary by default.
